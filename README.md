...
`examples/sample_config.json` is a complete configuration for trying things out. Give `run`
a small limit the first time; generation time grows with the size of the configuration.
